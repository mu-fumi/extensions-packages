...
function activate(context) {
  ...
  // 老板键
  let displayCode = vscode_1.commands.registerCommand(
    "extension.displayCode",
    () => {
      let lauage_arr_list = [
  ...
  // 下一页
  let getNextPage = vscode_1.commands.registerCommand(
    "extension.getNextPage",
    () => {
  ...
  // 上一页
  let getPreviousPage = vscode_1.commands.registerCommand(
  ...
  // 跳转某个页面
  let getJumpingPage = vscode_1.commands.registerCommand(
